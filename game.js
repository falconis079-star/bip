...
function roomClear() {
  ...
  $("playerBox").innerHTML = "<div style='padding:14px'>Выпуск Бипа. Нажми «Смотреть выпуск» или сразу «Дальше в бой».</div>";
...
function drawBip(x, y) {
  ...
  if (G.shield > 0) {
    ctx.strokeStyle = "rgba(108,255,178,.85)"; ctx.lineWidth = 5;
